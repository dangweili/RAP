...
fid_train = fopen('classification/rap2_ide_att_train.txt', 'w+');
fid_val = fopen('classification/rap2_ide_att_val.txt', 'w+');
fid_trainval = fopen('classification/rap2_ide_att_trainval.txt', 'w+');
fid_test = fopen('classification/rap2_ide_att_test.txt', 'w+'); % consist labeled and unlabeled images
